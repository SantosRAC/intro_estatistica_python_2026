...
df = pd.read_excel('caminho_para_seu_arquivo.xlsx', sheet_name='Planilha1')
```
...
![](tutorial_colab_arquivos.png){width=60% style="display: block; margin-left: auto; margin-right: auto;"}
