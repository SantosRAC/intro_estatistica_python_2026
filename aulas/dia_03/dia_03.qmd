...
# 2. Estimar parâmetros (Método dos Momentos/Máxima Verossimilhança)
...
# Curva Teórica
plt.plot(x, pdf_teorica, 'r-', lw=3, label=f'Normal Teórica ($\mu={mu:.1f}, \sigma={sigma:.1f}$)')
...
fig = tukey.plot_simultaneous(ylabel="Species", xlabel="Massa Corporal (Diferença)")
plt.title("Intervalos de Confiança de Tukey")
plt.show()
```
