...
```{python}
# Resumo descritivo do dataset penguins
print("Resumo numérico:")
print(penguins.describe().round(3))
```
...
print(penguins.groupby('species').agg(['mean','std']).round(3))

print("\nCorrelação de Pearson (variáveis numéricas):")
print(penguins.select_dtypes(include='number').corr().round(3))
